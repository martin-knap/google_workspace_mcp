...
- Office files (Word/Excel/PowerPoint/OpenDocument/RTF/CSV/EPUB): converted to Markdown with anydoc
- PDFs: converted with pdf-inspector and report exact pages that need OCR
